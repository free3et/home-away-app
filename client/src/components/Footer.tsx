...
export const Footer = () => {
  return (
    <footer className="w-full flex justify-center flex-col items-center">
      <div className="grid grid-cols-3 w-full sm:w-5/6 md:w-4/5 lg:w-3/4 xl:w-2/1 2xl:w-1/1 pb-3 border-b border-gray-300">
        ...
        <div className="flex flex-col">
          <h3 className="font-semibold pb-3">Hosting</h3>
          <Link to={"/"} className="py-2">
            HomeAway your home
          </Link>
          <Link to={"/"} className="py-2">
          ...
          <Link to={"/"} className="py-2">
            HomeAway-friendly apartments
          </Link>
        </div>
        <div className="flex flex-col">
          <h3 className="font-semibold pb-3">HomeAway</h3>
          <Link to={"/"} className="py-2">
            Newsroom
          </Link>
          <Link to={"/"} className="py-2">
          ...
          <ul className="flex p-3">
            <li className="px-2">
              <Link
                ...
                target="_blank"
                to="https://www.facebook.com/airbnb"
              >
                <svg
